...
const LandingHero = () => {
  ...
  const handleGetStarted = () => {
    if (user) {
      // User is already logged in, could navigate to dashboard or main app
  ...
  return (
    <section className="flex flex-col justify-center items-center py-24 gap-8 relative overflow-hidden">
      ...
      <div className="flex gap-4 z-10 animate-scale-in">
        <Button 
          size="lg" 
          className="rounded-full px-8 py-5 text-lg font-bold bg-indigo-600 hover:bg-indigo-700 text-white transition"
